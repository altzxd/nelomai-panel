...
ROUTE_RULES = [
    ...
    RouteRule(("GET",), "/admin/updates", "admin", "panel and agent versions page"),
    ...
    RouteRule(("GET",), "/admin/registration-links", "admin", "one-time user registration links"),
    RouteRule(("POST",), "/admin/registration-links", "admin", "create one-time user registration link"),
    RouteRule(("POST",), "/admin/registration-links/{link_id}/comment", "admin", "update registration link comment"),
    RouteRule(("POST",), "/admin/registration-links/revoke-unused", "admin", "revoke all unused registration links"),
